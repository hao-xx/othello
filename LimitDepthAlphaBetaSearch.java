 ...
 */
public class LimitDepthAlphaBetaSearch<S, A, P> implements
     ...
     */
    public static <STATE, ACTION, PLAYER> LimitDepthAlphaBetaSearch<STATE, ACTION, PLAYER> createFor(
            Game<STATE, ACTION, PLAYER> game, int maxDepth) {
        return new LimitDepthAlphaBetaSearch<STATE, ACTION, PLAYER>(game, maxDepth);
    }

    public LimitDepthAlphaBetaSearch(Game<S, A, P> game, int maxDepth) {
        this.game = game;
